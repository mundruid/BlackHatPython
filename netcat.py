...
def client_handler(client_socket):
    ...
    if command:
        ...
        while True:
            ...
            # now we rescieve until we see a linefeed
            cmd_buffer = ""
...
def main():
    ...
    if not listen and len(target) and port > 0:
        ...
        # this will block, so send CTRL-D if not sendint input to stdin
    ...
    # upload things, execute cmmands, and drop shell back
    # dependint on ouf command line options above
    if listen:
        server_loop()
